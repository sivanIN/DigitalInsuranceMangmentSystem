...
import { HomepremiumcalculatorComponent } from './components/homepremiumcalculator/homepremiumcalculator.component';
...
const route:Routes=[
  ...
  {path:"hospital",component:HospitalComponent},
  {path:"premiumcalculator",component:HomepremiumcalculatorComponent},
...
@NgModule({
  declarations: [
    ...
    HomepremiumcalculatorComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
